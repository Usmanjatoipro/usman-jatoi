...
export const Route = createFileRoute("/.lovable/oauth/consent")({
  ...
  errorComponent: ({ error }) => (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 text-sm text-muted-foreground">
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
      ...
      <p className="mt-3 text-sm text-muted-foreground">
        This lets {clientName} use the Usman Jatoi site tools as you — searching and reading your
        content, and reading contact leads if your account is an administrator.
      </p>
      {error && (
